...
<head>  
    <title>Welcome</title>
    <link rel="stylesheet" href="https://climbingtasmania.com/member.css?v=<?php echo time(); ?>"><!-- Get instant response when refreshing css cache -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/FileSaver.js/2.0.5/FileSaver.min.js"></script>
    <script src="//ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
    <script type="text/javascript" src="https://climbingtasmania.com/myapp.js"></script>
        ...
        <div class="row" id="header">
            <div class="row" id="row1"><!-- START OF ROW -->
                <div class="col" id="col1" style="text-align:center;">  
                    ...
                    <h1 id="welcome_txt">Welcome, <a href="https://climbingtasmania.com/register.php">Back to register</a></h1>
                    <br/>  
                    ...
                    <br/>
                    <a href="https://climbingtasmania.com/guest.php#row3" id="jump_list_down">Jump to make list</a>
                    <br/>
                    <br/>
                </div>
            </div><!--END OF ROW -->
