...
<head>  
    ...
    <script type="text/javascript" src="https://climbingtasmania.com/myapp.js"></script><!-- My javascript code file included-->
        ...
        <div class="row" id="header">
            <div class="row" id="row1"><!-- START OF ROW -->
                <div class="col" id="col1" style="text-align:center;">
                    ...
                    <h1 id="welcome_txt">Welcome, <span><?=$_SESSION['sess_user'];?></span>! <a href="https://climbingtasmania.com/logout.php">Logout</a></h1>
                    <br/>  
